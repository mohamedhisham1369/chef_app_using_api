...
Widget button ({   required VoidCallback function, required String name
})=>  ElevatedButton(
    onPressed: function,
    child:  Container(
      width: double.infinity,
      height: 55,
      padding: const EdgeInsets.symmetric(horizontal: 60, vertical: 12), // Adjust vertical padding
...
Widget deaafulticonbutton({required Function , required String label,required var icon ,var color})=> Center(
